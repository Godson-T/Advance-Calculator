...
sys.set_int_max_str_digits(
    1000000
)  # python limit integer string values up to 43300 digit,,to increase the system limit
        ...
        while True:
            try:
                ...
                if choice == 13:
                    ...
                    break
                if 0 > choice < 5:
                    a, b = int(input("Enter first number : ")), int(
                    ...
                    if choice == 5:
                        ...
                        base, exponent = int(input("Enter the Base: ")), int(
                            input("Enter the exponent")
                        )
                        print(f"{base}^{exponent}= {self.find_power(base,exponent)}")
                    elif choice == 8:
                        principal, rate, time = (
                            int(input("Enter the Principal amount: ")),
                            int(input("Enter the Rate of interest: ")),
                            int(input("Enter the Number of years: ")),
                        )
                        print(
                            f"Simple Interest= {self.calculate_simple_interest(principal,rate,time)}"
                        )
                    elif choice == 9:
                        ...
                        print(
                            f"Compounded Interest= {self.calculate_compound_interest(principal,rate,time,periods)}"
                        )
                    elif choice == 10:
                        n, a = int(input("Enter nth  Number: ")), int(
                            input("Enter the number: ")
                        )
                        print(f"{n}√{a}={self.find_n_th_root(n,a)}")
                    elif choice == 11:
                        x, n = int(input("Enter the 'a' Number: ")), int(
                            input("Enter the 'b' Number: ")
                        )
